...
class Brain:
    ...
    def __init__(self, sensors, actuators, handler, config=None):
        ...
        args = {
            ...
            'environment': 'simple',
            'agent': 'f1',
            'filename': 'brains/CARLA/config/config_inference_followlane_sb_ddpg_f1_carla.yaml'
        }
    ...
    def execute(self):
        ...
        final_curvature = (self.calculate_curvature_from(state)) / 2
       ...
       # print("________________")
        ...
        # if not missing_line:
        [action, _] = self.ddpg_agent.predict(np.array(state), deterministic=False)
        ...
        # To calculate distance to center on inference we use the 7 lowest points to reduce curve noise
