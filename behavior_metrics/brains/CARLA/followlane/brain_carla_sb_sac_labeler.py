...
from brains.CARLA.utils.lane_detector_labeler import LaneDetectorLabeler
...
class Brain:
    ...
    def __init__(self, sensors, actuators, handler, config=None):
        ...
        self.lane_detector_labeler = LaneDetectorLabeler(self.car,
                                          self.map,
                                          self.world,
                                          self.x_row,
                                          camera_transform,
    ...
    def execute(self):
        ...
        centers, image_processed, center_distance,_ = self.lane_detector_labeler.process_image(image_2)
